...
```
Serenity/
├── build.gradle                          ← 🧱 La base de todo
├── settings.gradle                       ← 🏷️ La tarjeta de identidad
│
└── src/test/
    ├── java/com/restaurant/qa/
    │   └── runners/
    │       └── TestRunner.java           ← 🚀 El botón de encendido
    │
    └── resources/
...
## 4. [serenity.conf](file:///c:/Users/usuario/iCloudDrive/SOFKA/Retos%20Marzo/Restaurants/Serenity/src/test/resources/serenity.conf) — ⚙️ El Cerebro de Configuración
...
## 5. [cucumber.properties](file:///c:/Users/usuario/iCloudDrive/SOFKA/Retos%20Marzo/Restaurants/Serenity/src/test/resources/cucumber.properties) — 🔌 El Cable que Conecta Todo
...
## 6. [logback-test.xml](file:///c:/Users/usuario/iCloudDrive/SOFKA/Retos%20Marzo/Restaurants/Serenity/src/test/resources/logback-test.xml) — 📋 El Filtro de Ruido
...
## 7. [HDU01_create_order.feature](file:///c:/Users/usuario/iCloudDrive/SOFKA/Retos%20Marzo/Restaurants/Serenity/src/test/resources/features/order_service/HDU01_create_order.feature) — 📖 La Historia del Usuario
...
> **Consejo de Senior QA:** Estos 7 archivos son el **esqueleto mínimo viable**. Un proyecto maduro tendría además: Step Definitions (el código Java que implementa cada paso Gherkin), Tasks y Questions del Screenplay, modelos de datos, y utilidades. Pero este esqueleto es suficiente para compilar, ejecutar, y generar tu primer reporte de Serenity.
